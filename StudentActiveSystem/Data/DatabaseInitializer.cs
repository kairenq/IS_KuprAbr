    ...
    public static class DatabaseInitializer
    {
        ...
        private static void SeedData(SQLiteConnection connection)
        {
            using (var command = new SQLiteCommand(connection))
            {
                ...
                var groups = new[]
                {
                    ("44.02.01", "Дошкольное образование", 1),
                    ("44.02.02", "Преподавание в начальных классах", 2),
                    ("15.01.05", "Сварщик (ручной и частично механизированной сварки (наплавки)", 3),
                    ("15.01.38", "Оператор-наладчик металлообрабатывающих станков", 4),
                    ("54.01.20", "Графический дизайнер", 5),
                    ("40.02.04", "Юриспруденция", 6),
                    ("09.02.07", "Информационные системы и программирование", 7),
                    ("10.02.05", "Обеспечение информационной безопасности автоматизированных систем", 8)
                };
